          ...
          {this.props.authedUser === null ? (
            ...
            <div>
              <Routes>
                ...
                <Route path="/view-pool/:id" render={() => <Poll />} />
                <Route path="/give-answer/:id" render={() => <GiveAnswer />} />
                <Route path="/add" render={() => <NewQuestion />} />
                <Route path="/leaderboard" render={() => <LeaderBoard />} />
                <Route path="/login" render={() => <Login />} />
                <Route path="/not-found" render={() => <ErrorPage />} />
              </Routes>
              {/* <Switch>  
...
const mapStateToProps = (state) => {
  const question_id = Object.keys(state.questions).sort(
  ...
  answered_quesion_id = question_id.filter((qid) =>
    answered_quesion_id.includes(qid)
  );
