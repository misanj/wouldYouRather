                  ...
                  <div className="card">
                     <div className="card-body ">
                        <ul className="list-unstyled">
                           <li className="media">
                              <img className="mr-3" width="100px" height="100px" src={user ? user.avatarURL : null} alt="Generic placeholder" />
...
export default connect(mapStateToProps,mapDispatchToProps)(GiveAnswer);